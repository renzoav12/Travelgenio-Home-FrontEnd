...
const Data = [
    ...
    link: 'https://' + window.location.hostname + '/hotels/search/METROPOLITAN_AREA/179992/' + dateStart + '/' + dateEnd + '/2/es' 
    },
    {
    ...
    link: 'https://' + window.location.hostname + '/hotels/search/METROPOLITAN_AREA/178229/' + dateStart + '/' + dateEnd + '/2/es'
    }
  ];
